...
#define ERA_AUTH_TOKEN "0c835a60-bb13-4b23-9ace-bb8722c534c6"
...
ERaString fromStr;
ERaWidgetTerminalBox terminal(fromStr, V0, V6);
/* WIFI SETUP */
...
void terminalCallback()
{
  ...
  if (fromStr == "LED ON")
  {
    terminal.print("Led is on.");
    digitalWrite(5, HIGH);
  }
  if (fromStr == "LED OFF")
  {
    terminal.print("Led is off.");
    digitalWrite(5, LOW);
  }
  terminal.flush();
}
